...
class backup_assignfeedback_recitannotation_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
       ...
       // $userinfo = $this->get_setting_value('userinfo');
        ...
        // Set data sources
        //if($userinfo){
            $annotation->set_source_sql('SELECT t1.*, t2.userid from {assignfeedback_recitannotation} t1 inner join {assign_submission} t2 on t1.submission = t2.id where t2.assignment = :assignment', array('assignment' => backup::VAR_PARENTID));
        //}
        
        $crit->set_source_table('assignfeedback_recitannot_crit', [
